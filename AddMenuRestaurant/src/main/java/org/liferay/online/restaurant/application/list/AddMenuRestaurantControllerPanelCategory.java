...
public class AddMenuRestaurantControllerPanelCategory extends BasePanelCategory {

	@Override
	public String getKey() {
		return AddMenuRestaurantControllerPanelCategoryKeys.CONTROL_PANEL_CATEGORY;
	}
